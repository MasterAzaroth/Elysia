        ...
        <div className="absolute left-1/2 -translate-x-1/2 -top-8">
          ...
          {isOpen && (
            <div className="absolute left-1/2 -translate-x-1/2 -top-40 w-64 h-32 rounded-3xl bg-brand-purple1 border border-white/10 p-3 shadow-xl pointer-events-auto flex p-4 gap-4">
              <Link className="w-1/2 h-full bg-brand-purple2 rounded-3xl flex flex-col justify-center items-center text-lg9" href="/trackingNutrition">
                <Hamburger className="w-8 h-8 mb-2" />
                <p>Nutrition</p>
              </Link>
              <Link className="w-1/2 h-full bg-brand-purple2 rounded-3xl flex flex-col justify-center items-center text-lg" href="/trackingTraining">
